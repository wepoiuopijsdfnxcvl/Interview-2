...
public class ButtonPopup extends Popup
{
    ...
    public void setShadeWidth(int val){
    	shadeWidth = val;
    }

    public ButtonPopup ( final JButton wb, PopupWay popupWay )
    {
        super ();
       ...
       // setCloseOnFocusLoss ( true );
        ...
        wb.addPropertyChangeListener ( new PropertyChangeListener ()
        {
            @Override
            public void propertyChange ( PropertyChangeEvent evt )
            {
                ...
                {
                    copySettings ( wb, copiedButton );
                }
            }
        } );
        wb.addHierarchyListener ( new HierarchyListener ()
        {
            @Override
        ...
        wb.addAncestorListener ( new AncestorListener ()
        {
            @Override
        ...
        wb.addComponentListener ( new ComponentAdapter ()
        {
            @Override
    ...
    private void updateContent ()
    {
        ...
        if ( isDown () )
        {
            UIUtils.setMargin(container, ( new Insets ( 0, margin, margin, margin ) ));
        }
        else if ( isUp () )
        {
        	 UIUtils.setMargin(container, ( new Insets ( margin, margin, 0, margin ) ));
        }
        else if ( isLeft () )
        {
        	 UIUtils.setMargin(container, ( new Insets ( margin, margin, margin, 0 ) ));
        }
        else if ( isRight () )
        {
        	 UIUtils.setMargin(container, ( new Insets ( margin, 0, margin, margin ) ));
        }
    ...
    public JPanel getContentPanel(){
    	return (JPanel)container.getComponent(0);
    }
    ...
    private JButton copy ( final JButton button )
    {
        ...
        UIUtils.setUndecorated(copy, true);
        copy.setCursor ( button.getCursor () );

        return copy;
    }

    private void copySettings ( JButton button, JButton copy )
    {
    ...
    public Shape getPopupShape ( ButtonPopup c )
    {
        //int shadeWidth = UIUtils.getShadeWidth(button);
        //int round = UIUtils.getRound(button);
    ...
    public void paint (Graphics g)
    {
        ...
        LafUtils.drawCustomWebBorder ( g2d, this, getPopupShape(this),  new Color ( 210, 210, 210 ),
                0, true, true );
        super.paint(g);
    }
}