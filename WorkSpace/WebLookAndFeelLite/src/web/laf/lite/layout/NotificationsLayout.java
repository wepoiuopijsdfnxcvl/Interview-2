...
import web.laf.lite.popup.NotificationPopup;
...
public class NotificationsLayout extends AbstractLayoutManager implements SwingConstants
{
     ...
     */
    private List<NotificationPopup> notifications = new ArrayList<NotificationPopup> ( 2 );
    ...
    {
        if ( component instanceof NotificationPopup )
        {
            notifications.add ( ( NotificationPopup ) component );
        }
    }
    ...
    public void layoutContainer ( Container parent )
    {
        if ( notifications.size () > 0 )
        {
            ...
            final boolean flowDisplayType = true; //check this
            ...
            int y = startY;
            int count = 0;
            for ( NotificationPopup popup : notifications )
            {
