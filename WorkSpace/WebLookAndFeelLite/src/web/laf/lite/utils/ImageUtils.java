...
public final class ImageUtils
{
    ...
    {
        return ImageUtils.getGraphicsConfiguration ().createCompatibleImage ( width, height );
    }

    public static BufferedImage createCompatibleImage ( int width, int height, int transparency )
    {
        return ImageUtils.getGraphicsConfiguration ().createCompatibleImage ( width, height, transparency );
    }
    ...
    public static BufferedImage toCompatibleImage ( BufferedImage image )
    {
        ...
        BufferedImage compatibleImage = ImageUtils.getGraphicsConfiguration ()
    ...
    {
        return image.getColorModel ().equals ( ImageUtils.getGraphicsConfiguration ().getColorModel () );
    }
    ...
    public static BufferedImage createColorImage ( Color color, int width, int height )
    {
        ...
        g2d.drawRoundRect ( 0, 0, width - 1, height - 1, 6, 4 );
        g2d.setPaint ( Color.WHITE );
        g2d.drawRoundRect ( 1, 1, width - 3, height - 3, 4,4 );
        g2d.setPaint ( color );
    ...
    {
        for(String l: Arrays.asList ( "png", "apng", "gif", "agif", "jpg", "jpeg", "jpeg2000", "bmp" ))
    ...
    public static BufferedImage createDisabledCopy ( Image img )
    {
        ...
        LafUtils.setupAlphaComposite ( g2d, 0.7f );
    ...
    {
        return createImageShade ( w, h, shape, shadeWidth, shadeOpacity, new Color ( 255, 255, 255, 0 ) );
    }
    ...
    public static BufferedImage createImageShade ( int w, int h, Shape shape, int shadeWidth, float shadeOpacity, Color clearColor )
    {
        ...
        BufferedImage shade = bi;//sf.filter ( bi, null );
	...
	{
	    return ImageUtils.getGraphicsEnvironment ().getDefaultScreenDevice ().getDefaultConfiguration ();
	}
	 ...
	 */
	static GraphicsEnvironment getGraphicsEnvironment ()
	{
