...
public class SkyTimer
{
     ...
     * @see #parseDelay(String)
     */
    public SkyTimer ( String name, String delay )
    {
     ...
     * @param delay delay between timer cycles in milliseconds
     */
    public SkyTimer ( String name, long delay )
    {
     ...
     */
    public SkyTimer ( long delay, long initialDelay )
    {
     ...
     * @param initialDelay delay before the first timer cycle run in milliseconds
     */
    public SkyTimer ( String name, long delay, long initialDelay )
    {
     ...
     * @see #parseDelay(String)
     */
    public SkyTimer ( String delay, ActionListener listener )
    {
     ...
     * @param listener action listener
     */
    public SkyTimer ( long delay, ActionListener listener )
    {
     ...
     * @see #parseDelay(String)
     */
    public SkyTimer ( String name, String delay, ActionListener listener )
    {
     ...
     * @param listener action listener
     */
    public SkyTimer ( String name, long delay, ActionListener listener )
    {
     ...
     * @param listener     action listener
     */
    public SkyTimer ( long delay, long initialDelay, ActionListener listener )
    {
     ...
     * @see #parseDelay(String)
     */
    public SkyTimer ( String name, String delay, String initialDelay, ActionListener listener )
    {
     ...
     * @param listener     action listener
     */
    public SkyTimer ( String name, long delay, long initialDelay, ActionListener listener )
    {
        super ();
        setName ( name );
        setDelay ( delay );
    ...
    {
        return new ActionEvent ( SkyTimer.this, 0, actionCommand, System.currentTimeMillis (), 0 );
    }
     ...
     * @see #parseDelay(String)
     */
    public static SkyTimer delay ( String delay, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer delay ( long delay, ActionListener listener )
    {
     ...
     * @see #parseDelay(String)
     */
    public static SkyTimer delay ( String name, String delay, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer delay ( String name, long delay, ActionListener listener )
    {
     ...
     * @see #parseDelay(String)
     */
    public static SkyTimer delay ( String delay, boolean useEventDispatchThread, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer delay ( long delay, boolean useEventDispatchThread, ActionListener listener )
    {
     ...
     * @see #parseDelay(String)
     */
    public static SkyTimer delay ( String name, String delay, boolean useEventDispatchThread, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer delay ( String name, long delay, boolean useEventDispatchThread, ActionListener listener )
    {
        SkyTimer once = new SkyTimer ( name, delay, listener );
     ...
     * @see #parseDelay(String)
     */
    public static SkyTimer repeat ( String delay, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer repeat ( long delay, ActionListener listener )
    {
     ...
     * @see #parseDelay(String)
     */
    public static SkyTimer repeat ( String name, String delay, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer repeat ( String name, long delay, ActionListener listener )
    {
     ...
     * @see #parseDelay(String)
     */
    public static SkyTimer repeat ( String delay, boolean useEventDispatchThread, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer repeat ( long delay, boolean useEventDispatchThread, ActionListener listener )
    {
     ...
     * @see #parseDelay(String)
     */
    public static SkyTimer repeat ( String name, String delay, boolean useEventDispatchThread, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer repeat ( String name, long delay, boolean useEventDispatchThread, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer repeat ( long delay, long initialDelay, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer repeat ( String name, long delay, long initialDelay, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer repeat ( long delay, long initialDelay, boolean useEventDispatchThread, ActionListener listener )
    {
     ...
     * @return newly created and started timer
     */
    public static SkyTimer repeat ( String name, long delay, long initialDelay, boolean useEventDispatchThread, ActionListener listener )
    {
        SkyTimer repeat = new SkyTimer ( name, delay, initialDelay, listener );
...
class DelayFormatException extends IllegalArgumentException
{
