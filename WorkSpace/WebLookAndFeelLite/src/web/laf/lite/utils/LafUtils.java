...
import web.laf.lite.ui.BorderMethods;
...
public final class LafUtils
{
    ...
    {
        return drawWebStyle ( g2d, component, new Color ( 210, 210, 210 ), 2, 2 );
    }
    ...
    {
        return drawWebStyle ( g2d, component, shadeColor, shadeWidth, round, fillBackground, webColored, Color.GRAY,
               Color.LIGHT_GRAY );
    }
    ...
    public static GradientPaint getWebGradientPaint ( int x1, int y1, int x2, int y2 )
    {
        ...
        {
            GradientPaint gp = new GradientPaint ( x1, y1, Color.WHITE, x2, y2, new Color ( 223, 223, 223 ) );
                                         ...
                                         Boolean mouseover, Boolean hasFocus )
    {
        return drawWebFocus ( g2d, component, focusType, shadeWidth, round, mouseover, hasFocus,
                focusType.equals ( FocusType.componentFocus ) ? new Color ( 160, 160, 160 ) : new Color ( 85, 142, 239, 128 ) );
    }
                                         ...
                                         Boolean mouseover, Boolean hasFocus, Color color )
    {
        return drawWebFocus ( g2d, component, focusType, shadeWidth, round, mouseover, hasFocus, color,
                focusType.equals ( FocusType.componentFocus ) ? new BasicStroke ( 1, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 1, new float[]{ 1, 2 }, 0 ) :  new BasicStroke ( 1.5f ) );
    }
                                            ...
                                            Boolean hasFocus )
    {
        ...
        {
            Object aa = setupAntialias ( g2d );
            Stroke os = setupStroke ( g2d, new BasicStroke ( 1, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 1, new float[]{ 1, 2 }, 0 ) );
        ...
        {
            Object aa = setupAntialias ( g2d );
            Stroke os = setupStroke ( g2d, new BasicStroke ( 1.5f ) );
                                   ...
                                   boolean round )
    {
        ...
        if ( shadeType.equals ( ShadeType.simple ) )
        {
            ...
            {
                g2d.setComposite (
                        AlphaComposite.getInstance ( AlphaComposite.SRC_OVER, 0.7f * currentComposite ) );
            }
