...
public class WebButtonGroup extends JPanel implements SwingConstants
{
    ...
    {
        if ( getUI () == null || !( getUI () instanceof PanelUI ) )
        {
    ...
    public JButton getWebButton ( int index )
    {
        return ( JButton ) getComponent ( index );
    }

    public JButton getWebButton ( String name )
    {
    ...
    public void updateButtons ()
    {
        ...
        for ( int i = 0; i < components.length; i++ )
        {
            ...
            {
                // Web UI
                ButtonUI ui = ( ButtonUI ) ( ( AbstractButton ) components[ i ] ).getUI ();
            ...
            else if ( isWebButtonGroup ( components[ i ] ) )
            {
                ...
                if ( lastWasButton )
                {
                    for ( Component component : wbg.getComponents () )
                    {
                        ...
                        {
                            ButtonUI ui = ( ButtonUI ) ( ( AbstractButton ) component ).getUI ();
                            if ( horizontal )
                            {
                                ui.setDrawLeft ( false );
                                ui.setDrawLeftLine ( false );
    ...
    private void restoreSides ( boolean horizontal, ButtonUI ui )
    {
    ...
    {
        return isButton ( component ) && ( ( AbstractButton ) component ).getUI () instanceof ButtonUI;
    }
    ...
    /**
     * Multi-update methods for some of ButtonUI properties
     */
