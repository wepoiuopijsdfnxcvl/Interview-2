...
public class TableHeaderUI extends BasicTableHeaderUI
{
    ...
    public Dimension getPreferredSize ( JComponent c )
    {
        ...
        ps.height = Math.max ( ps.height, 20 );
        return ps;
    }
}

class TableHeaderCellRenderer extends JLabel implements TableCellRenderer, javax.swing.plaf.UIResource
{
    ...
    public Component getTableCellRendererComponent ( JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column )
    {
        ...
        if ( table != null )
        {
            ...
            if ( !isPaintingForPrint && table.getRowSorter () != null )
            {
                ...
                java.util.List<? extends SortKey> sortKeys = table.getRowSorter ().getSortKeys ();
        ...
        // Title margin
        //setMargin ( new Insets ( 0, 10, 1, 10 ) );

        return this;
    }

    public static class UIResource extends TableHeaderCellRenderer implements javax.swing.plaf.UIResource
    {
    }
}