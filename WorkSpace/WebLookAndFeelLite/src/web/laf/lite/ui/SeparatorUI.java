...
public class SeparatorUI extends BasicSeparatorUI
{
    ...
    private Color separatorLightUpperColor = new Color ( 255, 255, 255, 5 );
    private Color separatorLightColor = Color.WHITE;
    private Color separatorUpperColor = new Color ( 176, 182, 188, 5 );
    private Color separatorColor = new Color ( 176, 182, 188 );

    private boolean reversedColors = false;
    private boolean drawLeadingLine = false;
    private boolean drawTrailingLine = true;
