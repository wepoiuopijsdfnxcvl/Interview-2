...
public class SliderUI extends BasicSliderUI implements BorderMethods
{
    public static final int MAX_DARKNESS = 5;

    protected Color trackBgTop = Color.WHITE;
    protected Color trackBgBottom = new Color ( 223, 223, 223 );
    protected int trackHeight = 9;
    protected int trackRound = 4;
    protected int trackShadeWidth = 2;

    protected boolean drawProgress = true;
    protected int progressRound = 2;
    protected int progressShadeWidth = 2;

    protected boolean drawThumb = true;
    protected Color thumbBgTop = Color.WHITE;
    protected Color thumbBgBottom = new Color ( 223, 223, 223 );
    protected int thumbWidth = 8;
    protected int thumbHeight = 18;
    protected int thumbRound = 2;
    protected int thumbShadeWidth = 2;
    protected boolean angledThumb = true;
    protected boolean sharpThumbAngle = true;
    protected int thumbAngleLength = 4;
    ...
    protected SkyTimer rolloverTimer;
    ...
    public void installUI ( final JComponent c )
    {
        ...
        // todo Requires optimizations
        // Rollover animator
        rolloverTimer = new SkyTimer ( "SkyProgressBarUI.animator", 40, new ActionListener ()
        {
            @Override
    ...
    public void paintThumb ( Graphics g )
    {
        if ( drawThumb )
        {
            ...
            if ( slider.isEnabled () )
            {
                LafUtils.drawShade ( g2d, ts, new Color ( 210, 210, 210 ), thumbShadeWidth );
            }
    ...
    public void paintTrack ( Graphics g )
    {
        ...
        // Track background & shade
        {
            ...
            if ( slider.isEnabled () )
            {
                LafUtils.drawShade ( g2d, ss, slider.isFocusOwner () ? new Color ( 85, 142, 239 ) : new Color ( 210, 210, 210 ),
                        trackShadeWidth );
            }
        ...
        if ( drawProgress )
        {
            ...
            if ( slider.isEnabled () )
            {
                LafUtils.drawShade ( g2d, ps, new Color ( 210, 210, 210 ), progressShadeWidth );
            }
        ...
        // Track border & focus
        {
            ...
            g2d.setPaint ( slider.isEnabled () ?
                    ( rolloverDarkBorderOnly && !isDragging () ? getBorderColor () : Color.GRAY ) :
                    Color.LIGHT_GRAY );
            g2d.draw ( ss );
        }
