...
public class RadioButtonUI extends BasicRadioButtonUI implements ShapeProvider
{
    ...
    static
    {
        CHECK_STATES.add ( new ImageIcon(RadioButtonUI.class.getResource("icons/empty.png")));
        for ( int i = 1; i <= 3; i++ )
        {
            CHECK_STATES.add (new ImageIcon(RadioButtonUI.class.getResource("icons/c" + i +".png")));
        }
    ...
    private Color bottomSelectedBgColor = new Color ( 213, 213, 213 );
    ...
    private SkyTimer bgTimer;

    private int checkIcon;
    private boolean checking;
    private SkyTimer checkTimer;
    ...
    public void installUI ( final JComponent c )
    {
        ...
        bgTimer = new SkyTimer ( "WebRadioButtonUI.bgUpdater", 40, new ActionListener ()
        {
            @Override
        ...
        checkTimer = new SkyTimer ( "RadioButtonUI.iconUpdater", 40, new ActionListener ()
        {
            @Override
            public void actionPerformed ( ActionEvent e )
            {
            ...
            public void paintIcon ( Component c, Graphics g, int x, int y )
            {
                ...
                if ( c.isEnabled () )
                {
                    LafUtils.drawShade ( g2d, shape,
                            c.isEnabled () && c.isFocusOwner () ? new Color ( 85, 142, 239 ) : new Color ( 210, 210, 210 ), shadeWidth );
                }
