...
public class PanelUI extends BasicPanelUI implements ShapeProvider, BorderMethods
{
    /**
     * Style settings.
     */
    ...
    public void installUI ( JComponent c )
    {
        ...
        panel.setBackground ( new Color(0xd1d1d1) );
    ...
    public void updateBorder ()
    {
        ...
        {
            // Actual margin
            Insets m = new Insets ( margin.top, margin.left , margin.bottom,  margin.right );

            // Calculating additional borders
            if ( !undecorated )
            {
                // Styling borders
                boolean actualDrawLeft = drawLeft ;
                boolean actualDrawRight = drawRight;
            ...
            if ( anyBorder || drawBackground )
            {
                ...
                if ( anyBorder && c.isEnabled () )
                {
                    LafUtils.drawShade ( g2d, borderShape,
                            drawFocus && focused ? new Color ( 85, 142, 239 ) : new Color ( 210, 210, 210 ), shadeWidth );
                }
