...
insert  into `sys_gl_qx`(`GL_ID`,`ROLE_ID`,`FX_QX`,`FW_QX`,`QX1`,`QX2`,`QX3`,`QX4`) values ('1','2',1,1,1,1,1,1),('2','1',0,0,1,1,1,1),('55896f5ce3c0494fa6850775a4e29ff6','7',0,0,1,0,0,0),('68f23fc0caee475bae8d52244dea8444','7',0,0,1,0,0,0),('7dfd8d1f7b6245d283217b7e63eec9b2','1',1,1,0,0,0,0),('ac66961adaa2426da4470c72ffeec117','1',1,0,0,1,0,0),('b0c77c29dfa140dc9b14a29c056f824f','7',1,0,1,0,0,0),('e74f713314154c35bd7fc98897859fe3','6',1,1,1,1,0,0),('f944a9df72634249bbcb8cb73b0c9b86','7',1,1,1,0,0,0);
...
insert  into `sys_menu`(`MENU_ID`,`MENU_NAME`,`MENU_URL`,`PARENT_ID`,`MENU_ORDER`,`MENU_ICON`,`MENU_TYPE`) values (1,'系统管理','#','0','1','icon-desktop','2'),(2,'组织管理','role.do','1','2',NULL,'2'),(4,'会员管理','happuser/listUsers.do','1','4',NULL,'2'),(5,'系统用户','user/listUsers.do','1','3',NULL,'2'),(6,'信息管理','#','0','2','icon-list-alt','2'),(7,'图片管理','pictures/list.do','6','1',NULL,'2'),(8,'性能监控','druid/index.html','9','1',NULL,'2'),(9,'系统工具','#','0','3','icon-th','2'),(10,'接口测试','tool/interfaceTest.do','9','2',NULL,'2'),(11,'发送邮件','tool/goSendEmail.do','9','3',NULL,'2'),(12,'置二维码','tool/goTwoDimensionCode.do','9','4',NULL,'2'),(13,'多级别树','tool/ztree.do','9','5',NULL,'2'),(14,'地图工具','tool/map.do','9','6',NULL,'2'),(15,'微信管理','#','0','2','icon-comments','2'),(16,'文本回复','textmsg/list.do','15','2',NULL,'2'),(17,'应用命令','command/list.do','15','4',NULL,'2'),(18,'图文回复','imgmsg/list.do','15','3',NULL,'2'),(19,'关注回复','textmsg/goSubscribe.do','15','1',NULL,'2'),(20,'在线管理','onlinemanager/list.do','1','5',NULL,'2'),(21,'打印测试','tool/printTest.do','9','7',NULL,'2');
