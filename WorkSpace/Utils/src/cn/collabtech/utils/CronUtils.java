...
public class CronUtils {
	...
	public static void main(String[] args) {
		...
		String cronStr = CronUtils.getCronStr(3,new Date());
	 ...
	 * 		2：每月    0 15 10 15 * ? 每月15号上午10点15分触发
	 * 		3：每周  0 59 2 ? * FRI 每周5凌晨2点59分触发；
	 */
	public static String getCronStr(int flag,Date date) {
		...
		switch (flag) {
		case 1:
			dateFormat = "ss mm HH dd MM ?";
			break;
		case 2:
			dateFormat = "ss mm HH dd * ?";
			break;
		case 3:
			//获取当前时间的星期时间
